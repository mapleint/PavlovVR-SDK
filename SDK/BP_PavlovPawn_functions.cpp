...
// Function BP_PavlovPawn.BP_PavlovPawn_C.OnHitByTazer
// (Event, Public, BlueprintEvent)

void ABP_PavlovPawn_C::OnHitByTazer()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_PavlovPawn.BP_PavlovPawn_C.OnHitByTazer");

	ABP_PavlovPawn_C_OnHitByTazer_Params params;
