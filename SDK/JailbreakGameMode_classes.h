...
public:
	...
	struct FTimerHandle                                CanStartMatch_Timer;                                      // 0x05F8(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance)
	int                                                InmateToGaurdRatio;                                       // 0x0600(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0604(0x0004) MISSED OFFSET
	TArray<class ABP_JailbreakSpawn_C*>                GaurdSpawns;                                              // 0x0608(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance)
	TArray<class ABP_JailbreakSpawn_C*>                InmateSpawns;                                             // 0x0618(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance)
	float                                              Escape_ToWin;                                             // 0x0628(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               LastRound_;                                               // 0x062C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
