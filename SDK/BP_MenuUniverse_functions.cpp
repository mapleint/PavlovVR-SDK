...
bool ABP_MenuUniverse_C::IsPlayerTooFar()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_MenuUniverse.BP_MenuUniverse_C.IsPlayerTooFar");

	ABP_MenuUniverse_C_IsPlayerTooFar_Params params;
...
void ABP_MenuUniverse_C::ReceiveTick(float* DeltaSeconds)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_MenuUniverse.BP_MenuUniverse_C.ReceiveTick");

	ABP_MenuUniverse_C_ReceiveTick_Params params;
...
void ABP_MenuUniverse_C::CameraExploit(bool bDetected)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_MenuUniverse.BP_MenuUniverse_C.CameraExploit");

	ABP_MenuUniverse_C_CameraExploit_Params params;
