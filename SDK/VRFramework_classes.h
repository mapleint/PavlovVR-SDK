...
{
public:
	TArray<struct FVRHandFingerJoint>                  FingerJoints;                                             // 0x0518(0x0010) (ZeroConstructor)
	class USkeletalMesh*                               LeftHandMesh;                                             // 0x0528(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UClass*                                      LeftHandAnimBlueprint;                                    // 0x0530(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FRotator                                    LeftHandRotation;                                         // 0x0538(0x000C) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0544(0x0004) MISSED OFFSET
	class USkeletalMesh*                               RightHandMesh;                                            // 0x0548(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UClass*                                      RightHandAnimBlueprint;                                   // 0x0550(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FRotator                                    RightHandRotation;                                        // 0x0558(0x000C) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              HandPitch;                                                // 0x0564(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
public:
	...
	struct FVRItemControllerState                      SavedOldState;                                            // 0x05A0(0x0050)
	unsigned char                                      UnknownData01[0x10];                                      // 0x05F0(0x0010) MISSED OFFSET
	struct FVRItemControllerState                      State;                                                    // 0x0600(0x0050) (BlueprintVisible, BlueprintReadOnly, Net)
	class AVRItem*                                     Pickup;                                                   // 0x0650(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              DropHoldDuration;                                         // 0x0658(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bHideMesh;                                                // 0x065C(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bSnapMesh;                                                // 0x065D(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData02[0x2];                                       // 0x065E(0x0002) MISSED OFFSET
...
public:
	...
	EAmmoType                                          AmmoType;                                                 // 0x04FC(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
public:
	...
	class AVRInventoryLogic*                           InventoryLogic;                                           // 0x0A00(0x0008) (Net, ZeroConstructor, IsPlainOldData)
	class AVRInventory*                                Inventory;                                                // 0x0A08(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class AVRLadder*                                   Ladder;                                                   // 0x0A10(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UClass*                                      VRControllerClass;                                        // 0x0A18(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bAdjustElevation;                                         // 0x0A20(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData05[0x3];                                       // 0x0A21(0x0003) MISSED OFFSET
	float                                              TeleportFadeDuration;                                     // 0x0A24(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bOOBEnabled;                                              // 0x0A28(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bReCenterRoomScale;                                       // 0x0A29(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x2];                                       // 0x0A2A(0x0002) MISSED OFFSET
	float                                              HeightOffsetScale;                                        // 0x0A2C(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     CenterOffset;                                             // 0x0A30(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bCameraClip;                                              // 0x0A3C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bTeleporting;                                             // 0x0A3D(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x2];                                       // 0x0A3E(0x0002) MISSED OFFSET
	class AVRController*                               LeftController;                                           // 0x0A40(0x0008) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	class AVRController*                               RightController;                                          // 0x0A48(0x0008) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	float                                              BodyRotationLerpExp;                                      // 0x0A50(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData08[0x4];                                       // 0x0A54(0x0004) MISSED OFFSET
	class UCurveFloat*                                 TouchpadInputCurve;                                       // 0x0A58(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bUseInventory;                                            // 0x0A60(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData09[0x7];                                       // 0x0A61(0x0007) MISSED OFFSET
	class UClass*                                      InventoryClass;                                           // 0x0A68(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UClass*                                      InventoryLogicClass;                                      // 0x0A70(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              OBBSnapInterval;                                          // 0x0A78(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData10[0x4];                                       // 0x0A7C(0x0004) MISSED OFFSET
	class UMaterial*                                   OBBMaterial;                                              // 0x0A80(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              NetLerpExp;                                               // 0x0A88(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              NetLerpAngularExp;                                        // 0x0A8C(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              NetUpdateInterval;                                        // 0x0A90(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData11[0x4];                                       // 0x0A94(0x0004) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnMenuPressed;                                            // 0x0A98(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnTriggerPressed;                                         // 0x0AA8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnGripPressed;                                            // 0x0AB8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnTrackpadPressed;                                        // 0x0AC8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	class UBehaviorTree*                               FakePlayerBehavior;                                       // 0x0AD8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
