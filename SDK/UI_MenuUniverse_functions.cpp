...
// Function UI_MenuUniverse.UI_MenuUniverse_C.Get_LogoVisForAdminPanel
// (Public, HasOutParms, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// ESlateVisibility               ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

ESlateVisibility UUI_MenuUniverse_C::Get_LogoVisForAdminPanel()
{
	static auto fn = UObject::FindObject<UFunction>("Function UI_MenuUniverse.UI_MenuUniverse_C.Get_LogoVisForAdminPanel");

	UUI_MenuUniverse_C_Get_LogoVisForAdminPanel_Params params;
