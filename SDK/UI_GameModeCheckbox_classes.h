...
// WidgetBlueprintGeneratedClass UI_GameModeCheckbox.UI_GameModeCheckbox_C
// 0x0042 (0x024A - 0x0208)
class UUI_GameModeCheckbox_C : public UUserWidget
{
public:
	...
	struct FString                                     FilterString;                                             // 0x0228(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	...
	EPavlovGameModeType                                GameMode;                                                 // 0x0249(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_GameModeCheckbox.UI_GameModeCheckbox_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_UI_GameModeCheckbox(int EntryPoint);
