...
// Function SearchAndDestroyGameMode.SearchAndDestroyGameMode_C.ResetSNDMatch
// (Event, Public, BlueprintEvent)

void ASearchAndDestroyGameMode_C::ResetSNDMatch()
{
	static auto fn = UObject::FindObject<UFunction>("Function SearchAndDestroyGameMode.SearchAndDestroyGameMode_C.ResetSNDMatch");

	ASearchAndDestroyGameMode_C_ResetSNDMatch_Params params;
