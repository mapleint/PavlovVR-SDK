...
struct UABP_BlowTorch_C_BlueprintUpdateAnimation_Params
{
	float*                                             DeltaTimeX;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function ABP_BlowTorch.ABP_BlowTorch_C.Turn Off Valve
struct UABP_BlowTorch_C_Turn_Off_Valve_Params
{
};

// Function ABP_BlowTorch.ABP_BlowTorch_C.SetValveAlpha
struct UABP_BlowTorch_C_SetValveAlpha_Params
{
...
struct UABP_BlowTorch_C_ExecuteUbergraph_ABP_BlowTorch_Params
{
