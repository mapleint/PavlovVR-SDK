...
// Function Gun_Base.Gun_Base_C.OnAttachModeChanged
// (Event, Public, BlueprintEvent)
// Parameters:
// bool*                          bEnabled                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// bool*                          bJustPicked                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void AGun_Base_C::OnAttachModeChanged(bool* bEnabled, bool* bJustPicked)
{
	static auto fn = UObject::FindObject<UFunction>("Function Gun_Base.Gun_Base_C.OnAttachModeChanged");

	AGun_Base_C_OnAttachModeChanged_Params params;
	params.bEnabled = bEnabled;
