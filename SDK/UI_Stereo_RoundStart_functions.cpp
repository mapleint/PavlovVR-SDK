...
{
	static auto fn = UObject::FindObject<UFunction>("Function UI_Stereo_RoundStart.UI_Stereo_RoundStart_C.Get_Counter_Text_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function UI_Stereo_RoundStart.UI_Stereo_RoundStart_C.Construct");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function UI_Stereo_RoundStart.UI_Stereo_RoundStart_C.ExecuteUbergraph_UI_Stereo_RoundStart");
