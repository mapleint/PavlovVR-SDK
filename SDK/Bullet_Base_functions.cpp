...
// Function Bullet_Base.Bullet_Base_C.GetBulletMesh
...
class UStaticMeshComponent* ABullet_Base_C::GetBulletMesh()
{
	static auto fn = UObject::FindObject<UFunction>("Function Bullet_Base.Bullet_Base_C.GetBulletMesh");

	ABullet_Base_C_GetBulletMesh_Params params;
