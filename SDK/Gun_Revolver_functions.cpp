...
// Function Gun_Revolver.Gun_Revolver_C.VerifyCanClose
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)

void AGun_Revolver_C::VerifyCanClose()
{
	static auto fn = UObject::FindObject<UFunction>("Function Gun_Revolver.Gun_Revolver_C.VerifyCanClose");

	AGun_Revolver_C_VerifyCanClose_Params params;
...
// Function Gun_Revolver.Gun_Revolver_C.TickRotation
// (BlueprintCallable, BlueprintEvent)

void AGun_Revolver_C::TickRotation()
{
	static auto fn = UObject::FindObject<UFunction>("Function Gun_Revolver.Gun_Revolver_C.TickRotation");

	AGun_Revolver_C_TickRotation_Params params;
...
// Function Gun_Revolver.Gun_Revolver_C.RotateChambers
// (BlueprintCallable, BlueprintEvent)

void AGun_Revolver_C::RotateChambers()
{
	static auto fn = UObject::FindObject<UFunction>("Function Gun_Revolver.Gun_Revolver_C.RotateChambers");

	AGun_Revolver_C_RotateChambers_Params params;
...
// Function Gun_Revolver.Gun_Revolver_C.OnPick
// (Event, Public, BlueprintEvent)
// Parameters:
// class AVRItemController**      ByController                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void AGun_Revolver_C::OnPick(class AVRItemController** ByController)
{
	static auto fn = UObject::FindObject<UFunction>("Function Gun_Revolver.Gun_Revolver_C.OnPick");

	AGun_Revolver_C_OnPick_Params params;
