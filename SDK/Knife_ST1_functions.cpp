...
bool AKnife_ST1_C::CanGetPickedBy(class AVRItemController** ByController)
{
	static auto fn = UObject::FindObject<UFunction>("Function Knife_ST1.Knife_ST1_C.CanGetPickedBy");

	AKnife_ST1_C_CanGetPickedBy_Params params;
