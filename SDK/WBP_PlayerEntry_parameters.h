...
struct UWBP_PlayerEntry_C_BndEvt__PlayerButton_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature_Params
{
};

// Function WBP_PlayerEntry.WBP_PlayerEntry_C.Init Entry
struct UWBP_PlayerEntry_C_Init_Entry_Params
{
...
struct UWBP_PlayerEntry_C_BndEvt__PlayerButton_K2Node_ComponentBoundEvent_3_OnButtonHoverEvent__DelegateSignature_Params
{
};
...
struct UWBP_PlayerEntry_C_BndEvt__PlayerButton_K2Node_ComponentBoundEvent_4_OnButtonHoverEvent__DelegateSignature_Params
{
};

// Function WBP_PlayerEntry.WBP_PlayerEntry_C.Construct
struct UWBP_PlayerEntry_C_Construct_Params
{
};

// Function WBP_PlayerEntry.WBP_PlayerEntry_C.RemoveSelection_Event
struct UWBP_PlayerEntry_C_RemoveSelection_Event_Params
{
};

// Function WBP_PlayerEntry.WBP_PlayerEntry_C.ExecuteUbergraph_WBP_PlayerEntry
struct UWBP_PlayerEntry_C_ExecuteUbergraph_WBP_PlayerEntry_Params
{
	int                                                EntryPoint;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function WBP_PlayerEntry.WBP_PlayerEntry_C.RemoveSelection__DelegateSignature
struct UWBP_PlayerEntry_C_RemoveSelection__DelegateSignature_Params
{
};

// Function WBP_PlayerEntry.WBP_PlayerEntry_C.PlayerSelected__DelegateSignature
struct UWBP_PlayerEntry_C_PlayerSelected__DelegateSignature_Params
{
	struct FString                                     SteamId;                                                  // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor)
