...
public:
	...
	unsigned char                                      UnknownData04[0xC];                                       // 0x0524(0x000C) MISSED OFFSET
	...
	bool TryAttach(unsigned char SlideModeSlot, bool bSliding);
...
public:
	...
	bool                                               bCaptureScene;                                            // 0x0540(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bHideGunOnCapture;                                        // 0x0541(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bHideSelfOnCapture;                                       // 0x0542(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x5];                                       // 0x0543(0x0005) MISSED OFFSET
	class UTextureRenderTarget2D*                      CaptureTexture;                                           // 0x0548(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FVector                                     CaptureOffset;                                            // 0x0550(0x000C) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FVector                                     LenseOffset;                                              // 0x055C(0x000C) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              ActivateDist;                                             // 0x0568(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              ActivateDistLine;                                         // 0x056C(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              BaseFOV;                                                  // 0x0570(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              MulFOV;                                                   // 0x0574(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              DivFOV;                                                   // 0x0578(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bZeroMaterial;                                            // 0x057C(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x057D(0x0003) MISSED OFFSET
	struct FName                                       ZeroParamName;                                            // 0x0580(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UDataTable*                                  ZeroingTable;                                             // 0x0588(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
{
public:
	class USkeletalMeshComponent*                      CustomMesh;                                               // 0x0160(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class USkeletalMesh*                               BarehandMesh;                                             // 0x0168(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USkeletalMesh*                               NATOHandMesh;                                             // 0x0170(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USkeletalMesh*                               RussianHandMesh;                                          // 0x0178(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	void SetCustomMesh(const struct FName& MeshName);
};
...
public:
	...
	unsigned char                                      UnknownData03[0x2];                                       // 0x0526(0x0002) MISSED OFFSET
	...
	class UDataTable*                                  BotPersonalityTable;                                      // 0x0548(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UDataTable*                                  EquipmentCostTable;                                       // 0x0550(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                MaxPlayers;                                               // 0x0558(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                MaximumCash;                                              // 0x055C(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                CashKillReward;                                           // 0x0560(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                CashTeamKillPenalty;                                      // 0x0564(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bIncrementTeamScore;                                      // 0x0568(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bAutoRespawn;                                             // 0x0569(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bKeepBodies;                                              // 0x056A(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bKeepPawnIfAlive;                                         // 0x056B(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                BodyPool;                                                 // 0x056C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              RespawnMaxDelay;                                          // 0x0570(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                InactivityInterval;                                       // 0x0574(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                InactivityThreashold;                                     // 0x0578(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                InactivityDormantThreashold;                              // 0x057C(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bDynamicSpawns;                                           // 0x0580(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bSpawnGhostOnLogin;                                       // 0x0581(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData05[0x2];                                       // 0x0582(0x0002) MISSED OFFSET
	int                                                RoundDuration;                                            // 0x0584(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              TeamLockDuration;                                         // 0x0588(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bAllowRoundDurationOverride;                              // 0x058C(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bAllowWeaponFilter;                                       // 0x058D(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bAllowCompetitive;                                        // 0x058E(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bAutoKickOnTK;                                            // 0x058F(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UClass*                                      BombClass;                                                // 0x0590(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData06[0x10];                                      // 0x0598(0x0010) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x11];                                      // 0x05A8(0x0011) MISSED OFFSET
	EBattlegroundsServerType                           ServerType;                                               // 0x05B9(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x6];                                       // 0x05BA(0x0006) MISSED OFFSET
	struct FString                                     MasterServerUrl;                                          // 0x05C0(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config)
...
public:
	...
	class UStaticMeshComponent*                        SphereMesh;                                               // 0x04E0(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	class UMaterialInstanceDynamic*                    BulletMaterial;                                           // 0x04E8(0x0008) (ZeroConstructor, IsPlainOldData)
	float                                              TracersLength;                                            // 0x04F0(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              TracerGirth;                                              // 0x04F4(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              TracerTimeScaleSpeed;                                     // 0x04F8(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              TracerTimer;                                              // 0x04FC(0x0004) (ZeroConstructor, IsPlainOldData)
	class UCurveFloat*                                 TracerOpacityCurve;                                       // 0x0500(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
// 0x0210 (0x0870 - 0x0660)
class APavlovItemController : public AVRItemController
{
public:
	class UWidgetComponent*                            UI;                                                       // 0x0660(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	class UStaticMeshComponent*                        PointerMesh;                                              // 0x0668(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	class AMainMenu*                                   MainMenu;                                                 // 0x0670(0x0008) (ZeroConstructor, IsPlainOldData)
	class AKillfeed*                                   Killfeed;                                                 // 0x0678(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x50];                                      // 0x0680(0x0050) MISSED OFFSET
	struct FTransform                                  TwoHandReloadBasis;                                       // 0x06D0(0x0030) (Net, IsPlainOldData)
	class AGun*                                        TwoHandReloadRefGun;                                      // 0x0700(0x0008) (ZeroConstructor, IsPlainOldData)
	class AGun*                                        TwoHandGripRefGun;                                        // 0x0708(0x0008) (ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        SelectionHandMesh;                                        // 0x0710(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData01[0x40];                                      // 0x0718(0x0040) MISSED OFFSET
	TArray<class AZombie*>                             KnockZombies;                                             // 0x0758(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData02[0x1];                                       // 0x0768(0x0001) MISSED OFFSET
	bool                                               bBypassMovement;                                          // 0x0769(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x2];                                       // 0x076A(0x0002) MISSED OFFSET
	float                                              TouchPadXValue;                                           // 0x076C(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              TouchPadYValue;                                           // 0x0770(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x0774(0x0004) MISSED OFFSET
	class AVRItem*                                     Selection;                                                // 0x0778(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bDominant;                                                // 0x0780(0x0001) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	bool                                               bTouchPadLocomotion;                                      // 0x0781(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x2];                                       // 0x0782(0x0002) MISSED OFFSET
	struct FVector                                     TwoHandPickOffset;                                        // 0x0784(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FVector                                     TwoHandDirection;                                         // 0x0790(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bMenuPressed;                                             // 0x079C(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x3];                                       // 0x079D(0x0003) MISSED OFFSET
	class AUberWheel*                                  WheelInstance;                                            // 0x07A0(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              TalkHeadDistance;                                         // 0x07A8(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FVector                                     FingerPointOffset;                                        // 0x07AC(0x000C) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData07[0x8];                                       // 0x07B8(0x0008) MISSED OFFSET
	struct FTransform                                  SelectionOffset;                                          // 0x07C0(0x0030) (Edit, DisableEditOnInstance, IsPlainOldData)
	class UMaterial*                                   SelectionMaterial;                                        // 0x07F0(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TEnumAsByte<ECollisionChannel>                     SelectionObjectType;                                      // 0x07F8(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData08[0x3];                                       // 0x07F9(0x0003) MISSED OFFSET
	float                                              SelectionSphereRadius;                                    // 0x07FC(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UStaticMesh*                                 SelectionHandMeshAsset;                                   // 0x0800(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              SelectionHandMeshScale;                                   // 0x0808(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData09[0x4];                                       // 0x080C(0x0004) MISSED OFFSET
	class USoundCue*                                   SelectionSoundCue;                                        // 0x0810(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UMaterial*                                   SelectionHandLeftMaterial;                                // 0x0818(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UMaterial*                                   SelectionHandRightMaterial;                               // 0x0820(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              BashCooldown;                                             // 0x0828(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              BashAcumMomentumDuration;                                 // 0x082C(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              BashDistanceThreashold;                                   // 0x0830(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              BashBeginRadius;                                          // 0x0834(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              BashVolumeRadius;                                         // 0x0838(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              BashPulsationInterval;                                    // 0x083C(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   BashSound;                                                // 0x0840(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UClass*                                      WheelClass;                                               // 0x0848(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UClass*                                      MainMenuClass;                                            // 0x0850(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UClass*                                      KillfeedClass;                                            // 0x0858(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FScriptMulticastDelegate                    OnSnapTurn;                                               // 0x0860(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
{
public:
	EGhostPointMode                                    PointMode;                                                // 0x0870(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	TArray<class ASpectatorTag*>                       SpectatorTags;                                            // 0x0AE8(0x0010) (ZeroConstructor)
	float                                              FreeViewSpeedMul;                                         // 0x0AF8(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0AFC(0x0004) MISSED OFFSET
	class UClass*                                      KillCamClass;                                             // 0x0B00(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class AKillCam*                                    KillCam;                                                  // 0x0B08(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bInSpectatorRoom;                                         // 0x0B10(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bIsOnGrace;                                               // 0x0B11(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x6];                                       // 0x0B12(0x0006) MISSED OFFSET
	class UClass*                                      SpectatorTVCameraClass;                                   // 0x0B18(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UClass*                                      SpectatorTagClass;                                        // 0x0B20(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              GraceDuration;                                            // 0x0B28(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              FreeViewSpeed;                                            // 0x0B2C(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundAttenuation*                           VoiceChatAttenuation;                                     // 0x0B30(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
public:
	...
	float                                              LastHapticTime;                                           // 0x0A28(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x4];                                       // 0x0A2C(0x0004) MISSED OFFSET
	class AAttachmentSuppressor*                       Suppresor;                                                // 0x0A30(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class AAttachmentSight*                            Sight;                                                    // 0x0A38(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class AAttachmentGrip*                             Grip;                                                     // 0x0A40(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FName                                       PicatinnySocket;                                          // 0x0A48(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              PicatinnyLength;                                          // 0x0A50(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      SightCompatibility;                                       // 0x0A54(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData10[0x3];                                       // 0x0A55(0x0003) MISSED OFFSET
	struct FName                                       GripSocket;                                               // 0x0A58(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      GripCompatibility;                                        // 0x0A60(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData11[0x7];                                       // 0x0A61(0x0007) MISSED OFFSET
	struct FName                                       SuppressorSocket;                                         // 0x0A68(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      SuppressorCompatibility;                                  // 0x0A70(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData12[0x7];                                       // 0x0A71(0x0007) MISSED OFFSET
	struct FGunAttachmentSetup                         DefaultAttachments;                                       // 0x0A78(0x0020) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FVector2D                                   AttachmentModeRange;                                      // 0x0A98(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              AttachmentModeHoldTime;                                   // 0x0AA0(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              AttachModeTime;                                           // 0x0AA4(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bHideIronOverride;                                        // 0x0AA8(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData13[0x7];                                       // 0x0AA9(0x0007) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnMagBoltRelease;                                         // 0x0AB0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	class UDataTable*                                  KnifeDamageTable;                                         // 0x0508(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              Damage;                                                   // 0x0510(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              MinDamage;                                                // 0x0514(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              MaxDamage;                                                // 0x0518(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              SpeedReference;                                           // 0x051C(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   StabSound;                                                // 0x0520(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	bool                                               bHasSpawnedProxy;                                         // 0x0548(0x0001) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	class UHapticFeedbackEffect_Base*                  ScrollHaptics;                                            // 0x0370(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              ScrollHapticThreashold;                                   // 0x0378(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x037C(0x0004) MISSED OFFSET
	class UStaticMesh*                                 PointerMesh;                                              // 0x0380(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UStaticMesh*                                 PointerLineMesh;                                          // 0x0388(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              PointerScale;                                             // 0x0390(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              PointerLineScale;                                         // 0x0394(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              PointerPitch;                                             // 0x0398(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              PointerDistance;                                          // 0x039C(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TEnumAsByte<ECollisionChannel>                     PointerChannel;                                           // 0x03A0(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bDebugPointer;                                            // 0x03A1(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData04[0x6];                                       // 0x03A2(0x0006) MISSED OFFSET
...
public:
	...
	bool                                               bCustomServer;                                            // 0x0149(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bWhitelist;                                               // 0x014A(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x1];                                       // 0x014B(0x0001) MISSED OFFSET
	int                                                RefreshListTime;                                          // 0x014C(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData)
	int                                                TimeLimit;                                                // 0x0150(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData)
	int                                                LimitedAmmoType;                                          // 0x0154(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bBroadcast;                                               // 0x0158(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bRotating;                                                // 0x0159(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData03[0x2];                                       // 0x015A(0x0002) MISSED OFFSET
	int                                                RotationIndex;                                            // 0x015C(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	TArray<struct FString>                             Blacklist;                                                // 0x0160(0x0010) (ZeroConstructor, Transient)
	TArray<struct FString>                             ModList;                                                  // 0x0170(0x0010) (ZeroConstructor, Transient)
	TArray<struct FString>                             Whitelist;                                                // 0x0180(0x0010) (ZeroConstructor, Transient)
...
{
public:
	class UPavlovZSpawnCMP*                            ZSpawnCMP;                                                // 0x05A8(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	class APavlov_GameLogic*                           CustomGameLogic;                                          // 0x05B0(0x0008) (ZeroConstructor, IsPlainOldData)
	TMap<struct FName, class UClass*>                  PlayerSkins;                                              // 0x05B8(0x0050) (Edit, ZeroConstructor, DisableEditOnInstance)
	class UClass*                                      CustomItemClass;                                          // 0x0608(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TArray<struct FString>                             BanList;                                                  // 0x0610(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	TArray<struct FString>                             Whitelist;                                                // 0x0620(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
...
public:
	...
	unsigned char                                      UnknownData02[0x3C];                                      // 0x014C(0x003C) MISSED OFFSET
	class USoundSubmix*                                ReverbSubmixGarage;                                       // 0x0188(0x0008) (ZeroConstructor, IsPlainOldData)
	class USoundSubmix*                                ReverbSubmixWarehouse;                                    // 0x0190(0x0008) (ZeroConstructor, IsPlainOldData)
	class USoundSubmix*                                ReverbSubmixTunnel;                                       // 0x0198(0x0008) (ZeroConstructor, IsPlainOldData)
	class UUIManager*                                  UIManager;                                                // 0x01A0(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x10];                                      // 0x01A8(0x0010) MISSED OFFSET
	bool                                               bTV;                                                      // 0x01B8(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x7];                                       // 0x01B9(0x0007) MISSED OFFSET
	class UReplayManager*                              ReplayManager;                                            // 0x01C0(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	int                                                Exp;                                                      // 0x01C8(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x4];                                       // 0x01CC(0x0004) MISSED OFFSET
	class UDedicatedServer*                            DedicatedServer;                                          // 0x01D0(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UServerStatusHelper*                         ServerStatusHelper;                                       // 0x01D8(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x8];                                       // 0x01E0(0x0008) MISSED OFFSET
	bool                                               bFirstBoot;                                               // 0x01E8(0x0001) (BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData07[0x7];                                       // 0x01E9(0x0007) MISSED OFFSET
	struct FString                                     MasterServerSessionId;                                    // 0x01F0(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	bool                                               bStopFindingGameServer;                                   // 0x0200(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x7];                                       // 0x0201(0x0007) MISSED OFFSET
	TArray<struct FPavlovServerInfo>                   ServerList;                                               // 0x0208(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	EMatchmakingState                                  MatchmakingState;                                         // 0x0218(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x7];                                       // 0x0219(0x0007) MISSED OFFSET
	struct FString                                     MasterServerUrl;                                          // 0x0220(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config)
	float                                              ServerQueryInterval;                                      // 0x0230(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData10[0x4];                                       // 0x0234(0x0004) MISSED OFFSET
	TArray<struct FString>                             DevList;                                                  // 0x0238(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config)
	struct FScriptMulticastDelegate                    OnMenuUniverseChanged;                                    // 0x0248(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnMatchmakingStateChanged;                                // 0x0258(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnQuickmatchFailed;                                       // 0x0268(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnLobbyStateChanged;                                      // 0x0278(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnLobbyStatusMessage;                                     // 0x0288(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnServerListUpdated;                                      // 0x0298(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnGetMapListAdvancedResult;                               // 0x02A8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnServerConnectFailure;                                   // 0x02B8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	class UServerConnector*                            ConnectorInstance;                                        // 0x02C8(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData11[0xF0];                                      // 0x02D0(0x00F0) MISSED OFFSET
	TMap<struct FName, class UPavlov_Map*>             MapDefinitions;                                           // 0x03C0(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData12[0x1A];                                      // 0x0410(0x001A) MISSED OFFSET
	EGameSessionState                                  GameSessionState;                                         // 0x042A(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData13[0x5];                                       // 0x042B(0x0005) MISSED OFFSET
	class UWorkshop*                                   Workshop;                                                 // 0x0430(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UMatchmaking*                                Matchmaking;                                              // 0x0438(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TArray<struct FPavlovAdvancedMap>                  AdvancedMapList;                                          // 0x0440(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
...
public:
	...
	struct FString                                     BalancingCSV;                                             // 0x0400(0x0010) (Net, ZeroConstructor)
	class UDataTable*                                  EquipmentTable;                                           // 0x0410(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TArray<struct FName>                               EquipmentIndexCache;                                      // 0x0418(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	TArray<struct FKillfeedEntry>                      Killfeed;                                                 // 0x0428(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	struct FScriptMulticastDelegate                    OnKillfeedEntry;                                          // 0x0438(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	TArray<struct FFavoriteServer>                     FavoriteServers;                                          // 0x0140(0x0010) (ZeroConstructor, Config)
	TArray<struct FString>                             RegionFilters;                                            // 0x0150(0x0010) (ZeroConstructor, Config)
	bool                                               bForceNoPostProcess;                                      // 0x0160(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bAutoSwapHands;                                           // 0x0161(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bLeftEyeRendering;                                        // 0x0162(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bSwapControllers;                                         // 0x0163(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bVirtualStock;                                            // 0x0164(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	EGripMode                                          GripModeVive;                                             // 0x0165(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	EGripMode                                          GripModeOculus;                                           // 0x0166(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bSmoothTurn;                                              // 0x0167(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	float                                              SmoothTurnRate;                                           // 0x0168(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	ECustomAction                                      MainHandAction;                                           // 0x016C(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	ECustomAction                                      OffHandAction;                                            // 0x016D(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bAutoSprint;                                              // 0x016E(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bLiteFootStepHaptics;                                     // 0x016F(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bLockInventory;                                           // 0x0170(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bHeadLocomotion;                                          // 0x0171(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bFreeSpectating;                                          // 0x0172(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x5];                                       // 0x0173(0x0005) MISSED OFFSET
	TArray<struct FSpectatorViews>                     SpectatorViews;                                           // 0x0178(0x0010) (ZeroConstructor, Config)
	bool                                               bInvertTouchpad;                                          // 0x0188(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bArmKillfeed;                                             // 0x0189(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x6];                                       // 0x018A(0x0006) MISSED OFFSET
	struct FString                                     VoiceDevice;                                              // 0x0190(0x0010) (ZeroConstructor, Config)
	TArray<struct FString>                             FavoriteMaps;                                             // 0x01A0(0x0010) (ZeroConstructor, Config)
	bool                                               bRealTimeReverb;                                          // 0x01B0(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bUseAudioThread;                                          // 0x01B1(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bNoAmbisonics;                                            // 0x01B2(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bSwapMenuScoreboard;                                      // 0x01B3(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	EGripMode                                          GripMode;                                                 // 0x01B4(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	EVRSmoothLocomotionMode                            SmoothLocomotionMode;                                     // 0x01B5(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	EGoreLevel                                         GoreLevel;                                                // 0x01B6(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData03[0x1];                                       // 0x01B7(0x0001) MISSED OFFSET
	float                                              GrabForceThreashold;                                      // 0x01B8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bUseGrabForce;                                            // 0x01BC(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x01BD(0x0003) MISSED OFFSET
	struct FString                                     StartUpMap;                                               // 0x01C0(0x0010) (ZeroConstructor, Config)
	bool                                               bForceTubeHaptics;                                        // 0x01D0(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData05[0x7];                                       // 0x01D1(0x0007) MISSED OFFSET
	TArray<uint64_t>                                   MutedPlayers;                                             // 0x01D8(0x0010) (ZeroConstructor, Config)
...
public:
	...
	class USoundCue*                                   OutOfAmmoSound;                                           // 0x0458(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   LastMagazineGrabSound;                                    // 0x0460(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UHapticFeedbackEffect_Base*                  MagazineGrabHaptic;                                       // 0x0468(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
// 0x04B0 (0x0F90 - 0x0AE0)
class APavlovPawn : public APavlovPawnBase
{
public:
	unsigned char                                      UnknownData00[0x20];                                      // 0x0AE0(0x0020) MISSED OFFSET
	class UVRAvatarComponent*                          Avatar;                                                   // 0x0B00(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	class UVHealthComponent*                           HealthComponent;                                          // 0x0B08(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	class UWidgetComponent*                            PlayerInfo;                                               // 0x0B10(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	class UVRSelectionComponent*                       SelectionComponent;                                       // 0x0B18(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	class UDamageTrackerComponent*                     DamageTracker;                                            // 0x0B20(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	class UInstancedSourceBusComponent*                FootStepAudio;                                            // 0x0B28(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	class UInstancedSourceBusComponent*                LeftCameraAudio;                                          // 0x0B30(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	class UInstancedSourceBusComponent*                RightCameraAudio;                                         // 0x0B38(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	class UAvatarSkin*                                 AvatarSkin;                                               // 0x0B40(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData01[0x10];                                      // 0x0B48(0x0010) MISSED OFFSET
	struct FEquipmentDefinition                        EquipmentToLoad;                                          // 0x0B58(0x0048)
	unsigned char                                      UnknownData02[0x18];                                      // 0x0BA0(0x0018) MISSED OFFSET
	struct FFingerTracking                             FingerTrackingSent;                                       // 0x0BB8(0x0003) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData03[0x5];                                       // 0x0BBB(0x0005) MISSED OFFSET
	struct FKillInfo                                   LatestKillInfo;                                           // 0x0BC0(0x0070)
	unsigned char                                      UnknownData04[0x8];                                       // 0x0C30(0x0008) MISSED OFFSET
	float                                              StopSprintTimer;                                          // 0x0C38(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              PlaySpaceExploitKillTimer;                                // 0x0C3C(0x0004) (ZeroConstructor, IsPlainOldData)
	class UHolsterComponent*                           MainWeaponHolster;                                        // 0x0C40(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UWatch*                                      WatchComponent;                                           // 0x0C48(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UVoiceComponent*                             Voice;                                                    // 0x0C50(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData05[0x20];                                      // 0x0C58(0x0020) MISSED OFFSET
	TArray<struct FWoundInfo>                          DelayedWoundInfoList;                                     // 0x0C78(0x0010) (ZeroConstructor, Transient)
	TArray<class UParticleSystemComponent*>            HeadshotParticleInstances;                                // 0x0C88(0x0010) (ExportObject, ZeroConstructor, Transient)
	TArray<class UAudioComponent*>                     HeadshotSoundInstances;                                   // 0x0C98(0x0010) (ExportObject, ZeroConstructor, Transient)
	unsigned char                                      UnknownData06[0x4];                                       // 0x0CA8(0x0004) MISSED OFFSET
	struct FFingerTracking                             FingerTracking;                                           // 0x0CAC(0x0003) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x1];                                       // 0x0CAF(0x0001) MISSED OFFSET
	struct FPlayerAvatar                               AvatarSkinInfo;                                           // 0x0CB0(0x0010) (BlueprintVisible, BlueprintReadOnly, Net)
	float                                              SlowTimer;                                                // 0x0CC0(0x0004) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	float                                              CorpseTime;                                               // 0x0CC4(0x0004) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	bool                                               bInvulnerable;                                            // 0x0CC8(0x0001) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      RadioChannel;                                             // 0x0CC9(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x2];                                       // 0x0CCA(0x0002) MISSED OFFSET
	int                                                Armour;                                                   // 0x0CCC(0x0004) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	int                                                HelmetArmour;                                             // 0x0CD0(0x0004) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	int                                                TeamId;                                                   // 0x0CD4(0x0004) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	bool                                               bVoiceActive;                                             // 0x0CD8(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x3];                                       // 0x0CD9(0x0003) MISSED OFFSET
	float                                              ImpactWeight;                                             // 0x0CDC(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UCurveFloat*                                 ImpactCurve;                                              // 0x0CE0(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UClass*                                      BloodSplatClass;                                          // 0x0CE8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                MaxBloodSplats;                                           // 0x0CF0(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData10[0x4];                                       // 0x0CF4(0x0004) MISSED OFFSET
	class UParticleSystem*                             HeadshotParticle;                                         // 0x0CF8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UParticleSystem*                             HeadshotBleedParticle;                                    // 0x0D00(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   HeadshotBleedSound;                                       // 0x0D08(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   HeadshotSound;                                            // 0x0D10(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   HeadshotSound2D;                                          // 0x0D18(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   FallDamageSound;                                          // 0x0D20(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FName                                       HeadBoneName;                                             // 0x0D28(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FName                                       ChestBoneName;                                            // 0x0D30(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UParticleSystem*                             HelmetHitParticle;                                        // 0x0D38(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   HelmetHitSound;                                           // 0x0D40(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              SpawnProtectionDuration;                                  // 0x0D48(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FVector                                     PlaySpaceLimits;                                          // 0x0D4C(0x000C) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bUnderPlaySpaceExploit;                                   // 0x0D58(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData11[0x3];                                       // 0x0D59(0x0003) MISSED OFFSET
	float                                              PlaySpaceExploitKillDelay;                                // 0x0D5C(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bCameraClipProtectionEnabled;                             // 0x0D60(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData12[0x3];                                       // 0x0D61(0x0003) MISSED OFFSET
	float                                              CameraClipThreashold;                                     // 0x0D64(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              CameraClipMaxDuration;                                    // 0x0D68(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData13[0x4];                                       // 0x0D6C(0x0004) MISSED OFFSET
	class USoundCue*                                   WearArmourSound;                                          // 0x0D70(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   WearHelmetSound;                                          // 0x0D78(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              MaxSlowDuration;                                          // 0x0D80(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              HitSlowDuration;                                          // 0x0D84(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              SlowMultiplier;                                           // 0x0D88(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData14[0x4];                                       // 0x0D8C(0x0004) MISSED OFFSET
	TArray<struct FName>                               SlowBones;                                                // 0x0D90(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance)
	class USoundCue*                                   HitSound;                                                 // 0x0DA0(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   HitSoundVictim;                                           // 0x0DA8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   HitSoundShooter;                                          // 0x0DB0(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   ZombieHitSound;                                           // 0x0DB8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UParticleSystem*                             HitEffect;                                                // 0x0DC0(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UParticleSystem*                             HitEffectVictim;                                          // 0x0DC8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TArray<class UAnimMontage*>                        HitMontages;                                              // 0x0DD0(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance)
	class USoundCue*                                   RogerSound;                                               // 0x0DE0(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UClass*                                      WatchClass;                                               // 0x0DE8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              ADSZThreashold;                                           // 0x0DF0(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData15[0x4];                                       // 0x0DF4(0x0004) MISSED OFFSET
	class UMaterialInterface*                          XRayMaterialTeam0;                                        // 0x0DF8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UMaterialInterface*                          XRayMaterialTeam1;                                        // 0x0E00(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundAttenuation*                           VoiceAttenuation;                                         // 0x0E08(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundEffectSourcePresetChain*               VoiceEffectChain;                                         // 0x0E10(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 VoiceVolumeCurve;                                         // 0x0E18(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundSourceBus*                             RadioSourceBus;                                           // 0x0E20(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bPickDisableOnDead;                                       // 0x0E28(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bXRayEnabled;                                             // 0x0E29(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bForceFirstPerson;                                        // 0x0E2A(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData16[0x5];                                       // 0x0E2B(0x0005) MISSED OFFSET
	TArray<class UClass*>                              DefaultAvatarSkins;                                       // 0x0E30(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance)
	class UClass*                                      TazerClass;                                               // 0x0E40(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class APavlovPlayerState*                          RevivePlayerState;                                        // 0x0E48(0x0008) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	struct FScriptMulticastDelegate                    OnVoiceChanged;                                           // 0x0E50(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnRadioToggle;                                            // 0x0E60(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnAvatarSkinChanged;                                      // 0x0E70(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	class APavlov_PlayerProxy*                         WorkshopProxy;                                            // 0x0E80(0x0008) (Net, ZeroConstructor, IsPlainOldData)
	class UDataTable*                                  AvatarSkinTable;                                          // 0x0E88(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UAISlotManager*                              AISlotManager;                                            // 0x0E90(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	float                                              TimeSinceLastFootStep;                                    // 0x0E98(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              FootStepTimer;                                            // 0x0E9C(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	int                                                SprintFootStepCount;                                      // 0x0EA0(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bArmorRattlePlayed;                                       // 0x0EA4(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData17[0x3];                                       // 0x0EA5(0x0003) MISSED OFFSET
	class USurfaceFXAsset*                             FootStepSneak;                                            // 0x0EA8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USurfaceFXAsset*                             FootStepWalk;                                             // 0x0EB0(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USurfaceFXAsset*                             FootStepRun;                                              // 0x0EB8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   ArmorRattleSound;                                         // 0x0EC0(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   DefaultFootStepSound;                                     // 0x0EC8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   DefaultRunFootStepSound;                                  // 0x0ED0(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   ConcreteFootStepSound;                                    // 0x0ED8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   ConcreteRunFootStepSound;                                 // 0x0EE0(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   MetalFootStepSound;                                       // 0x0EE8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   MetalRunFootStepSound;                                    // 0x0EF0(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   CarpetFootStepSound;                                      // 0x0EF8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   CarpetRunFootStepSound;                                   // 0x0F00(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   FabricFootStepSound;                                      // 0x0F08(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   FabricRunFootStepSound;                                   // 0x0F10(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   WoodFootStepSound;                                        // 0x0F18(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   WoodRunFootStepSound;                                     // 0x0F20(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   GlassFootStepSound;                                       // 0x0F28(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   GlassRunFootStepSound;                                    // 0x0F30(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   WaterFootStepSound;                                       // 0x0F38(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   WaterRunFootStepSound;                                    // 0x0F40(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   DirtFootStepSound;                                        // 0x0F48(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundCue*                                   DirtRunFootStepSound;                                     // 0x0F50(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UHapticFeedbackEffect_Base*                  FootStepHaptic;                                           // 0x0F58(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              FootStepInterval;                                         // 0x0F60(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              MinFootStepInterval;                                      // 0x0F64(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              SneakSpeedMul;                                            // 0x0F68(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              RagdollMinDamping;                                        // 0x0F6C(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              RagdollLifeDuration;                                      // 0x0F70(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              RagdollLife;                                              // 0x0F74(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FConstraintProfileProperties>        ConstraintDefaultProfiles;                                // 0x0F78(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData18[0x8];                                       // 0x0F88(0x0008) MISSED OFFSET
	...
	bool HasAmmoOfType(class AAmmoBox* AmmoBox);
	...
	int GetAmmoAmountFiltered(class AAmmoBox* InAmmoBox);
...
public:
	...
	class UTexture*                                    SplashScreenTexture;                                      // 0x07B0(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FVector2D                                   SplashScreenScale;                                        // 0x07B8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FVector2D                                   SplashScreenOffset;                                       // 0x07C0(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FScriptMulticastDelegate                    OnBuyingChanged;                                          // 0x07C8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnTeamKilled;                                             // 0x07D8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnHeadsetScaleChanged;                                    // 0x07E8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData04[0x18];                                      // 0x07F8(0x0018) MISSED OFFSET
...
public:
	...
	bool                                               bUpdateFavoritesOnly;                                     // 0x003D(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	void OnLobbyPingFailure(class UPingIP* PingOperation, const struct FString& Hostname);
	void OnLobbyPingComplete(class UPingIP* PingOperation, const struct FString& Hostname, int TimeMS);
	void OnLobbyListUpdate();
	void OnCommunityPingListComplete();
	void OnCommunityPingFailure(class UPingIP* PingOperation, const struct FString& Hostname);
	void OnCommunityPingComplete(class UPingIP* PingOperation, const struct FString& Hostname, int TimeMS);
...
public:
	...
	class UServerStatusHelper*                         StatusHelper;                                             // 0x0078(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData01[0x5];                                       // 0x0080(0x0005) MISSED OFFSET
	EConnectorFailureReason                            FailureReason;                                            // 0x0085(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	void OnStatusReceived(const struct FServerStatusInfo& StatusInfo);
...
{
public:
	struct FServerContainerInfo                        ServerContainerInfo;                                      // 0x0028(0x00E8) (BlueprintVisible, BlueprintReadOnly)
	bool                                               bOfflineContainer;                                        // 0x0110(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0111(0x0003) MISSED OFFSET
	float                                              LastPingAlpha;                                            // 0x0114(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              LastUpdateAlpha;                                          // 0x0118(0x0004) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	bool                                               bUseNewPingMethod;                                        // 0x0034(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x53];                                      // 0x0035(0x0053) MISSED OFFSET
	bool                                               bUpdating;                                                // 0x0088(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bNotFull;                                                 // 0x0089(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bNotEmpty;                                                // 0x008A(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bNoPassword;                                              // 0x008B(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x008C(0x0004) MISSED OFFSET
	struct FString                                     GMFilter;                                                 // 0x0090(0x0010) (BlueprintVisible, ZeroConstructor)
	TArray<struct FServerDetails>                      ServerList;                                               // 0x00A0(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	struct FScriptMulticastDelegate                    OnUpdate;                                                 // 0x00B0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	...
	void OnPingComplete(class UPingIP* PingOperation, const struct FString& Hostname, int TimeMS);
	void NewOnPingListComplete();
	void NewOnPingFailure(class UPingIP* PingOperation, const struct FString& Hostname);
	void NewOnPingComplete(class UPingIP* PingOperation, const struct FString& Hostname, int TimeMS);
...
public:
	...
	bool                                               bClientRecievedResponse;                                  // 0x0058(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x17];                                      // 0x0059(0x0017) MISSED OFFSET
	struct FTimerHandle                                AutoCloseHandle;                                          // 0x0070(0x0008)
...
{
public:
	int                                                MaxKillEventEntries;                                      // 0x00F0(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	TArray<struct FKillEvent>                          KillEvents;                                               // 0x0148(0x0010) (ZeroConstructor)
	...
	void ReportPlayer(const struct FString& ReportPlayerId, const struct FString& ReportedById);
	bool PostStats(bool bReportedOnly, const struct FString& URL);
	void PlayerKilled(const struct FKillEvent& KillEvent);
	class UJsonUtilsObj* GetStatsAsJson(bool bReportedOnly);
	...
	bool GetPlayers(bool bReportedOnly, TArray<struct FPlayerStats>* PlayersStatistics);
	TArray<struct FKillEvent> GetKillEvents();
	void AddAssist(const struct FString& UniqueId);
};
...
public:
	...
	bool                                               bHasPlayerProxy;                                          // 0x0438(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x7];                                       // 0x0439(0x0007) MISSED OFFSET
	struct FName                                       SkinOverride;                                             // 0x0440(0x0008) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
