...
struct UWBP_AdminPanelPopup_C_WarningLine1Bind_Params
{
	struct FText                                       ReturnValue;                                              // (Parm, OutParm, ReturnParm)
};

// Function WBP_AdminPanelPopup.WBP_AdminPanelPopup_C.Construct
struct UWBP_AdminPanelPopup_C_Construct_Params
{
};

// Function WBP_AdminPanelPopup.WBP_AdminPanelPopup_C.ChangeText
struct UWBP_AdminPanelPopup_C_ChangeText_Params
{
...
struct UWBP_AdminPanelPopup_C_ExecuteUbergraph_WBP_AdminPanelPopup_Params
{
	int                                                EntryPoint;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function WBP_AdminPanelPopup.WBP_AdminPanelPopup_C.PopulateText__DelegateSignature
struct UWBP_AdminPanelPopup_C_PopulateText__DelegateSignature_Params
{
	struct FText                                       PopupText;                                                // (BlueprintVisible, BlueprintReadOnly, Parm)
};
